...
TEST_CASE("sgl::Menu"){
  ...
  REQUIRE(menu.item_name(0) == "double item 1"_sv);  
  REQUIRE(menu.item_name(0) == "float item 1"_sv);  
  REQUIRE(menu.item_name(0) == "int item 1"_sv);  
  REQUIRE(menu.item_name(0) == "link to page 2"_sv);  
