...
namespace ryu::detail {
  static constexpr uint64_t DOUBLE_POW5_INV_SPLIT2[15][2] = {
  ...
  static constexpr uint32_t POW5_INV_OFFSETS[19] = {0x54544554,
                                                    0x04055545,
                                                    0x10041000,
                                                    0x00400414,
                                                    0x40010000,
  ...
  static constexpr uint64_t DOUBLE_POW5_SPLIT2[13][2] = {
  ...
  inline constexpr int      pow5_table_size = 26;
  static constexpr uint64_t DOUBLE_POW5_TABLE[pow5_table_size] = {
      1ull,
      5ull,
      25ull,
      125ull,
  ...
  static inline void double_computeInvPow5(const uint32_t i, uint64_t* const result) {
    ...
    const uint64_t* const mul = detail::DOUBLE_POW5_INV_SPLIT2[base]; // 1/5^base2
    if (offset == 0) {
      result[0] = mul[0];
      result[1] = mul[1];
      return;
