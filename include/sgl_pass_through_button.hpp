...
namespace sgl {
  ...
  constexpr PassThroughButton<ItemImpl, Traits>::PassThroughButton(StringView name_and_text) noexcept
      : Base(name_and_text) {}

  template <typename ItemImpl, typename Traits>
  constexpr PassThroughButton<ItemImpl, Traits>::PassThroughButton(StringView name, StringView text) noexcept
      : Base(name, text) {}
  ...
  PassThroughButton<ItemImpl, Traits>::PassThroughButton(StringView     name,
                                               StringView     text,
  ...
  template <typename ClickHandler,
            enable_if_is_click_handler<ClickHandler, typename Traits::item_type>>
  void PassThroughButton<ItemImpl, Traits>::set_click_handler(ClickHandler&& click_handler) noexcept {
