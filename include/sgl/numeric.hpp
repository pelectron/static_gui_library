 ...
 * This file contains the sgl::Numeric class and the various sgl::numeric() overloads.
 * @version 0.1
 * @date 2022-09-23
 *
...
namespace sgl {
   ...
   *
    This class models a numeric item. It consists of a value of type T,
    a delta value of type T and a formatter to format T's into strings.
   *
    The default behaviour of this item when it is edited is as follows: an input of
  ...
  public:
    ...
    /**
      Construct a numeric item with default formatter and default
    ...
    /**
      create a numeric item at compile time for floats and doubles.
      This is only needed for compile time floating point numeric items. Use the overload
    ...
    /**
      Construct a numeric item with custom formatter, but default
      input handling.
     *
    ...
    /**
      Construct a numeric item with custom formatter and input
      handler.
     *
      @tparam Formatter formatter type, see formatter_check for more details.
  ...
  private:
    /**
      execute the formatter and format val into this item's text
  ...
  /**
    ...
    This is only needed for compile time floating point numeric
  ...
  /**
    ...
    @tparam CharT character type
    @tparam T value type
    @tparam Formatter formatter type, see enable_if_is_value_formatter for more details.
    @tparam InputHandler input handler type. See enable_if_is_input_handler for more details.
    @param initial_value inital value
    @param delta delta value
    @param formatter formatter instance
